  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck.png" />
       ...
       How about moderating your own server with Dark Bot? Create your own free world and create your own playlist, experience this pleasure with the best sounds. 
	  </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
  
            <Link href={"https://discord.com/oauth2/authorize?client_id=1194716797685993602&scope=bot%20applications.commands&permissions=2146958847"}>
              <a
                className={
...
Vote Dark Bot</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            ...
            <a href="https://discord.com/oauth2/authorize?client_id=1194716797685993602&scope=bot%20applications.commands&permissions=2146958847" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
              <i className="fab fa-discord mr-2" />Invite Dark bot
            </a>
          </div>
